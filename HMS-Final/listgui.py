...
def click_restaurant():
     call(["python", "rest_mgmt.py"])
def click_spa():
    call(["python", "spa_etc.py"])
...
class UPDATE:
    def __init__(self):
        ...
        root.title("Update Guest Information")
        ...
        self.Message6.place(relx=0.11, rely=0.01, relheight=0.3, relwidth=0.75)
        self.Message6.configure(background="#800080")
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="#000000")
        self.Message6.configure(highlightbackground="#d9d9d9")
        self.Message6.configure(highlightcolor="black")
        self.Message6.configure(text='''The Grand Jade Hotel Update User data''')
        self.Message6.configure(width=700)

        self.Button2 = Button(self.Frame1)
        self.Button2.place(relx=0.18, rely=0.33, height=103, width=750)
        ...
        self.Button2.configure(text='''1.Whispering Bamboo Restaurant''')
        self.Button2.configure(width=566)
        self.Button2.configure(command=click_restaurant)

        self.Button3 = Button(self.Frame1)
        self.Button3.place(relx=0.18, rely=0.50, height=103, width=750)
        ...
        self.Button3.configure(text='''2.Spa, STD, Pool, Events''')
        self.Button3.configure(width=566)
        self.Button3.configure(command=click_spa)

        self.Button6 = Button(self.Frame1)
        self.Button6.place(relx=0.18, rely=0.67, height=103, width=750)
        self.Button6.configure(activebackground="#DAA520")
        ...
        self.Button6.configure(text='''3.Exit Portal''')
